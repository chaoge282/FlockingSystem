...
HFILES 	= flock.${H} Vector.${H} Utility.${H} Matrix.${H} Camera.${H} boid.${H} gauss.${H}
OFILES 	= flock.o Vector.o Utility.o Matrix.o Camera.o boid.o gauss.o
PROJECT = main
...
flock.o: flock.${C} flock.${H} boid.${H} gauss.${H}
	${CC} $(CFLAGS) -c flock.${C}
